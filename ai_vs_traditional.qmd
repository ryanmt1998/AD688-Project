...
# Get absolute path
csv_path = os.path.abspath("lightcast_job_postings.csv")
...
# 2️⃣ Make sure SOC_5_NAME is a string
df["TITLE_CLEAN"] = df["TITLE_CLEAN"].astype(str)

# 3️⃣ Define AI-related keywords
ai_keywords = [
