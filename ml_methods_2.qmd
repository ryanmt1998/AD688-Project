...
# # === 1️⃣ Create simplified NAICS column BEFORE split ===
# df = df.withColumn("NAICS_MAJOR", substring(col("NAICS_2022_6").cast("string"), 1, 2))

# # === 2️⃣ Split data AFTER creating column ===
# train_df, test_df = df.randomSplit([0.8, 0.2], seed=42)

# # === 3️⃣ Build Decision Tree pipeline ===
...
# # === 4️⃣ Convert to pandas sample for sklearn visualization ===
...
# # === 5️⃣ Train sklearn version for visualization ===
# sk_tree = SkDecisionTree(max_depth=5, random_state=42)
# sk_tree.fit(X, y)

# # === 6️⃣ Plot using Matplotlib ===
